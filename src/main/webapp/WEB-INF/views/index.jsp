    ...
    <div class="container-fluid h-10 mb-20 mt-10">
        <div class=" h-10 mb-20 mt-10 justify-content-center">
          <a class="navbar-brand mt-1 ml-1" href="#">
            <img src ="resources/img/1.png" alt="아이콘" style="height: auto; margin:0 auto; width: 100px" src="#">
          </a>
        </div>
    </div>
...
<body>
  ...
  <div class="p-3 bg-white mt-6 rounded-lg shadow-md transition-colors duration-500">
    <div id="slide" val="1" mx="3">
      <li id="img1"><img src="resources/img/img1.jpg" alt="이미지1" /></li>
      <li id="img2"><img src="resources/img/img3.jpg" alt="이미지2" /></li>
      <li id="img3"><img src="resources/img/img4.jpg" alt="이미지3" /></li>
    </div>
  </div>
...
<div class="p-4" id="search-bar">
  ...
  <div id="board-box" class="grid grid-cols-4 gap-1 place-items-center h-24">
   ...
   <c:forEach items="${boardList}" var="mvo">
    <div class="w- p-6 m-10 bg-white rounded-xl shadow-xl hover:shadow-2xl hover:scale-105 transition-all transform duration-500">
